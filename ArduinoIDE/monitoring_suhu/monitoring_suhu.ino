...
String apiKey = "L7ZZDP0S3VOTMF2T"; //Write API key of your ThingSpeak channel
const char* server = "api.thingspeak.com"; // API for thingspeak
//****************************************************************************************

const char *ssid = "WIJAYA"; // Wifi SSID of your Internet connection
const char *pass = "iswari71"; // Password
